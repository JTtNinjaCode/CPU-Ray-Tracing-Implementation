...
//   world.push_back(std::make_shared<sphere>(point3(-4, 1, 0), 1.0,
//   matte_mat)); auto metal_mat = std::make_shared<metal>(
...
//   camera cam;
//   cam.initialize_perspective(400, 16.0 / 9.0, point3(13, 2, 3), vec3(0, 0,
//   0),
//                              1, 20.0, 100, 5);
...
//   std::ofstream of("output.ppm");
//   camera cam;
//   cam.initialize_perspective(400, 16.0 / 9.0, point3(0, 0, 2), vec3(0, 0,
//   -2),
//                              1, 60.0, 10, 10);
//   cam.background_ = std::make_shared<solid_color>(color(0.7, 0.8, 1.0));
//   cam.render(of, world);
...
//       random_double()); if ((center - point3(4, 0.2, 0)).length() > 0.9) {
...
//   std::ofstream of("output.ppm");
//   camera cam;
//   cam.initialize_perspective(400, 16.0 / 9.0, point3(13, 2, 3), point3(0, 0,
//   0),
//                              1, 20, 100, 5);
//   cam.background_ = std::make_shared<solid_color>(color(0.7, 0.8, 1.0));
//   // bvh 與 list 的差異比較 ?
...
//       auto choose_mat = random_double();
//       point3 center(a + 0.9 * random_double(), 0.2, b + 0.9 *
//       random_double()); point3 center2 = center + vec3(0, random_double(0,
//       .3), 0);
//
...
//               std::make_shared<solid_color>(albedo));
//           world.push_back(
//               std::make_shared<sphere>(center, center2, 0.2,
//               sphere_material));
//         } else if (choose_mat < 0.95) {
//           // metal
//           color albedo = random_vec(0.5, 1);
...
//   std::ofstream of("output.ppm");
//   camera cam;
//   cam.initialize_perspective(1080, 16.0 / 9.0, point3(18, 3, 4), vec3(0, 0,
//   0),
//                              1, 30.0, 1000, 5);
//   cam.background_ = std::make_shared<solid_color>(color(0.7, 0.8, 1.0));
//   cam.render(of, world);
...
//   camera cam;
//   std::ofstream of("output.ppm");
//   cam.initialize_perspective(400, 16.0 / 9.0, point3(1, 1, 9), point3(0, 0,
//   0),
//                              1, 80);
//   cam.background_ = std::make_shared<solid_color>(color(0.7, 0.8, 1.0));
//   cam.render(of, world);
...
//   camera cam;
//   std::ofstream of("output.ppm");
//   cam.initialize_fisheye(400, 16.0 / 9.0, point3(1, 1, 9), point3(0, 0,
//   0), 1.0,
//                          60);
//   cam.background_ = std::make_shared<solid_color>(color(0.7, 0.8, 1.0));
//   cam.render(of, world);
...
//   std::ofstream of("output.ppm");
//   camera cam;
//   cam.initialize_perspective(764, 16.0 / 9.0, point3(26, 3, 6), point3(0, 2,
//   0),
//                              1, 20.0, 1000, 5);
...
//   // 0), 1.0,
//   //                        90, 1000, 5);
//   cam.initialize_perspective(1080, 1, point3(1.1, 1.8, 1.1), point3(0), 1.0,
//   90,
//                              100, 5);
...
//   world.push_back(std::make_shared<quad>(point3(0, 0, 0), vec3(0, 555, 0),
//                                          vec3(0, 0, 555), red));
//   world.push_back(std::make_shared<quad>(point3(113, 554, 127), vec3(330, 0,
//   0),
//                                          vec3(0, 0, 305), light));
...
void rotate() {
  ...
  std::shared_ptr<hittable> box1 = box(point3(265, 0, 295), point3(430, 330, 460), white);
  box1 = std::make_shared<rotate_z>(box1, 15);
  world.push_back(box1);

  camera cam;
  cam.initialize_fisheye(400, 1.0, point3(278, 278, -100), point3(278, 278, 0), 1, 90, 100, 5);
  cam.initialize_perspective(400, 1.0, point3(278, 278, -800), point3(278, 278, 0), 1, 40, 1000, 5);
...
//
//  auto light = std::make_shared<diffuse_light>(color(7, 7, 7));
//  world.push_back(std::make_shared<quad>(point3(123, 554, 147), vec3(300, 0,
//  0),
//                                         vec3(0, 0, 265), light));
